...
import { collection, query, orderBy, getDocs, updateDoc, doc, deleteDoc } from 'firebase/firestore';
    ...
    // ... (existing updateStatus function with minor add for Reject logic if needed, but generic handles it)
    ...
    // ... (render)
    {
        order.status === 'Pending' && (
            <>
                ...
                <button onClick={() => updateStatus(order.id, 'Rejected')} className={styles.btnReject}>✕ Reject</button>
            </>
        )
    }
    {
